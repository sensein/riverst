...
from ..models import NodesConfig
from ..models import SchemasConfig
...
def load_config(flow_config_path: str) -> FlowConfigurationFile:
    ...
    # adjust for combined config file
    config = config.get("flows_configuration", {})
    ...
    NodesConfig(**config.get("node_config", {}))
