...
async def general_transition_callback(
    ...
    if result.get("status") == "success":
        ...
        message = (
            "CRITICAL INSTRUCTION: You are rejoining the flow at a point "
            "where you have not completed all required tasks. "
            "LOOK AT YOUR INSTRUCTIONS CAREFULLY AND MAKE SURE YOU UNDERSTAND THE TASKS YOU NEED TO COMPLETE, "
            "and SKIP ANY TASKS THAT I HAVE NOT ASKED YOU TO COMPLETE AGAIN: " + message
        )
