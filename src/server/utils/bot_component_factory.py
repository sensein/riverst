    ...
    def build_instruction(self) -> str:
        ...
        if self.languages:
            ...
            instruction += (
                ...
                f"If that language is among {', '.join(self.languages)}, "
                f"reply in the same language used by the user in the last interaction.\n"
                f"If the lanugage is NOT among {', '.join(self.languages)}, "
                f"reply in one and only one of these languages ({', '.join(self.languages)}) with a message indicating "
                ...
                f"reply in English with a message indicating that you do not understand or speak that language "
                f"and pretend you do not understand the user.\n"
            )
